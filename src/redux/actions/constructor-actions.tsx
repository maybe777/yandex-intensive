...
export const addItem = (item: IBurgerItem) => (dispatch: AppDispatch) => {
...
export const removeItem = (removeIndex: number) => (dispatch: AppDispatch) => {
...
export const sortItem = (fromIndex: number, toIndex: number) => (dispatch: AppDispatch) => {
